...
namespace Momat.Editor
{
    public static class AnimationCurveBake
    {
        ...
        public static int Bake(ref Keyframe[] keys, float frameRate, InterpolationMode mode = InterpolationMode.Auto)
        {
            ...
            ThreadSafe.Bake(nativeKeys, frameRate, bakedKeys,
                new SampleRange() { startFrameIndex = 0, numFrames = frameCount });
        ...
        public static class ThreadSafe
        {
            ...
            public static int Bake(NativeArray<Keyframe> keyframes, float frameRate, NativeArray<Keyframe> bakedFrames,
                SampleRange sampleRange)
            {
